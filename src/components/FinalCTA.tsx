...
const defaultProps: Required<Omit<FinalCTAProps, "backgroundImage">> & { backgroundImage: string } = {
  ...
  buttons: [
    ...
    { label: "Services", variant: "secondary" },
  ],
};
            ...
            {buttons.map((button, index) => {
              ...
              return (
                <button
                  ...
                  className={`flex justify-center items-center gap-[8px] sm:gap-[10px] px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 text-center text-[14px] sm:text-[15px] md:text-[16px] font-medium leading-[150%] transition ${
                    isPrimary
