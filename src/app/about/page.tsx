      ...
      <section className="py-8 sm:py-12 bg-white md:py-16">
        <div className="px-4 sm:px-6 md:px-6 lg:px-[100px] max-w-7xl mx-auto">
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            <Reveal as="p" className="inline-flex w-fit items-center justify-center gap-[10px] rounded-[8px] border border-[#1E2A44] bg-[#1E2A44] px-2.5 sm:px-3 py-1 sm:py-1.5 text-[9px] sm:text-[10px] md:text-[12px] font-semibold uppercase tracking-[0.2em] text-white">
              About Us
            </Reveal>
            <Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 sm:gap-x-8 md:gap-x-12 lg:gap-x-[170px] gap-y-6 sm:gap-y-8 md:gap-y-12 lg:gap-y-16 mt-6 sm:mt-8 md:mt-12 lg:mt-16">
            <Reveal className="space-y-2.5 sm:space-y-3 md:space-y-4">
            ...
            <Reveal className="space-y-2.5 sm:space-y-3 md:space-y-4" delay={60}>
              <div className="flex items-start justify-between gap-3 sm:gap-4">
                <h3 className="text-[18px] sm:text-[24px] md:text-[32px] lg:text-[40px] font-bold text-[#1E1E1E]" style={{ fontFamily: "'Figtree', sans-serif", lineHeight: '0.9' }}>
            ...
            <Reveal className="space-y-2.5 sm:space-y-3 md:space-y-4" delay={120}>
              <div className="flex items-start justify-between gap-3 sm:gap-4">
                <h3 className="text-[18px] sm:text-[24px] md:text-[32px] lg:text-[40px] font-bold text-[#1E1E1E]" style={{ fontFamily: "'Figtree', sans-serif", lineHeight: '0.9' }}>
            ...
            <Reveal className="space-y-2.5 sm:space-y-3 md:space-y-4" delay={180}>
              <div className="flex items-start justify-between gap-3 sm:gap-4">
                <h3 className="text-[18px] sm:text-[24px] md:text-[32px] lg:text-[40px] font-bold text-[#1E1E1E]" style={{ fontFamily: "'Figtree', sans-serif", lineHeight: '0.9' }}>
      ...
      <section className="bg-[#f5f9ff] py-8 sm:py-12 md:py-16">
        <div className="px-4 sm:px-6 md:px-8 lg:px-[100px] max-w-7xl mx-auto">
          <div className="mb-6 sm:mb-8 md:mb-12">
            <Reveal as="p" className="inline-flex w-fit items-center justify-center gap-[10px] rounded-[8px] border border-white bg-[#1E2A44] px-2.5 sm:px-3 py-1 sm:py-1.5 text-center text-[11px] sm:text-[12px] md:text-[14px] font-medium leading-[150%] text-white mb-3 sm:mb-4" style={{ fontFamily: 'Moderat, sans-serif' }}>
              Our Team
            </Reveal>
            <Reveal>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {teamMembers.map((member, index) => (
              <Reveal key={member.name} className="flex flex-row gap-3 sm:gap-4" delay={index * 70}>
